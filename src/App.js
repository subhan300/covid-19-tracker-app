...
// console.log("kkkk",Table_Data)
  ...
  return (
    <div className="App">
      ...
      <h1 style={{with:"150px",marginTop:"80px"}}>CORONA TRACKER APP</h1>
    <div className="drop"> <FormControl className="app_dropdown">
    
    <Select  onChange={selectCountry} value={inputCountry}  
    style={{color:"purple",fontWeight:"bold",borderBottom:"4px red !important",width:"350px"}}
    >
